...
const GRAMMAR_CHALLENGES = [
  ...
  { id: 6, difficulty: 2, question: "Which sentence shows correct use of an exclamation mark in speech?", options: ["He shouted. Stop that!", "He shouted, stop that!", "He shouted to stop that.", "He shouted stop that."], answer: "He shouted. Stop that!", explanation: "When reporting a shout, you can use a full stop after the reporting verb and an exclamation mark for the action.", skill: "Punctuation in Speech" },
  ...
  { id: 20, difficulty: 2, question: "Which sentence uses correct punctuation for speech?", options: ["She said, I am ready.", "She said: I am ready.", "She said that she was ready.", "She said, that she was ready."], answer: "She said that she was ready.", explanation: "Use reported speech without quotes and commas when not using direct speech.", skill: "Punctuation in Speech" },
